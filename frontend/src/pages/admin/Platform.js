...
const Platform = () => {
  ...
  const fetchIpcSections = async () => {
    ...
    try {
      const response = await fetch("https://lexnet-backend.onrender.com/api/ipc"); // API endpoint to get IPC sections
  ...
  const handleAddSection = async () => {
    ...
    try {
      const response = await fetch("https://lexnet-backend.onrender.com/api/ipc", {
        method: "POST",
        headers: {
  ...
  const handleRemoveSection = async (id) => {
    try {
      const response = await fetch(`https://lexnet-backend.onrender.com/api/ipc/${id}`, {
        method: "DELETE",
      });
